...
| `TaskboardBoardModel.js` | Pure selected/pinned agent resolution plus phase-aware TodoWrite grouping and truthful full-list progress layouts for the chalk face and compact low-zoom card. |
