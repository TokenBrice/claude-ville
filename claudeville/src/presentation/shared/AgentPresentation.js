...
const PROVIDER_ICONS = Object.freeze({ claude: 'C', codex: 'X', gemini: 'G', git: '#', grok: 'R', kimi: 'K', omp: 'M', opencode: 'O', deepseek: 'D' });
...
const PROVIDER_LABELS = Object.freeze({
    claude: 'Claude', codex: 'Codex', gemini: 'Gemini', git: 'Git', grok: 'Grok', kimi: 'Kimi', omp: 'OMP', opencode: 'OpenCode', deepseek: 'DeepSeek',
});
