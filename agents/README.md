...
| [plans/claudeville-building-harmonization-upgrade-plan.md](plans/claudeville-building-harmonization-upgrade-plan.md) | ready | 2026-06-15 | manifest.yaml + live sprites + BuildingVisualRegistry | After fresh baseline; phased §6 | sprites:validate, world:validate-buildings, capture/visual-diff; re-calibrate pixel anchors §6.3 |
