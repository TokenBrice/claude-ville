...
| [plans/v0.23-visual-overhaul.md](plans/v0.23-visual-overhaul.md) | active | 2026-07-12 (v0.22.0) | live source + exploration workflow `wf_cabc5b89-938` | Yes; 4 parallel wave-1 agents (file-disjoint), then serial waves 2–4 on `IsometricRenderer.js` | Harbor flock restoration, water/vegetation/atmosphere upgrades, accessory-anchoring fix. All procedural, no new PNGs. Verify per-wave `node --check` + browser QA at :4000 |
