...
| [plans/v0.24-sound-atmosphere.md](plans/v0.24-sound-atmosphere.md) | ready | 2026-07-12 (v0.23.0) | live source (`shared/AmbientAudioController.js`, `character-mode/AtmosphereState.js`, `VillageDirector.js`) | After fresh baseline; 5 phases, each independently shippable | Reactive procedural sound rework. Per-phase browser checks via `__claudeVilleAtmosphere.setHour/setWeather` + `__claudevilleAudio()`; see plan §6 |
